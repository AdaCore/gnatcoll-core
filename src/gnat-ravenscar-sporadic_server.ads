...
--                                                                          --
--                       G N A T . RAVENSCAR.SPORADIC_SERVER                --
--                                                                          --
--                                 S p e c                                  --
--                                                                          --
...
--  package My_Sporadic_Server is new GNAT.Ravenscar.Sporadic_Server
--      (Task_Priority => 10,
...
package GNAT.Ravenscar.Sporadic_Server is
...
end GNAT.Ravenscar.Sporadic_Server;
