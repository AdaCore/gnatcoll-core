...
--                                                                          --
--             G N A T . RAVENSCAR.TIMED_OUT_SPORADIC_SERVER                --
--                                                                          --
--                                 S p e c                                  --
--                                                                          --
...
--  procedure Handler;
--  package My_Sporadic_Server is new GNAT.Ravenscar.Timed_Out_Sporadic_Server
--      (Task_Priority => 10,
...
with GNAT.Ravenscar.Timers.One_Shot_Timer;
...
package GNAT.Ravenscar.Timed_Out_Sporadic_Server is
...
private
   ...
   package My_Timer is new GNAT.Ravenscar.Timers.One_Shot_Timer;
