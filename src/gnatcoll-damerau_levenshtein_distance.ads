...
with GNATCOLL.Damerau_Levenshtein_Generic;

function GNATCOLL.Damerau_Levenshtein_Distance is
  new GNATCOLL.Damerau_Levenshtein_Generic (Character, Positive, String);
