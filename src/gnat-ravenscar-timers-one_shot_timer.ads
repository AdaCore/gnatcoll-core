...
--                                                                          --
--                	        G N A T . RAVENSCAR.TIMERS.ONE_SHOT_TIMER                       --
--                                                                          --
--                                 S p e c                                  --
--                                                                          --
...
generic
package GNAT.Ravenscar.Timers.One_Shot_Timer is
   ...
   protected Events is
      ...
      procedure Set_Action
        (Instant      : Ada.Real_Time.Time;
         Action       : access procedure);
   private
      The_Action : GNAT.Ravenscar.Timers.Timer_Action;
   end Events;

end GNAT.Ravenscar.Timers.One_Shot_Timer;
