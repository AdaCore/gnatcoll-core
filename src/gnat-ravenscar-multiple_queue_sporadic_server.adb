...
with GNAT.Ravenscar.Utils;

package body GNAT.Ravenscar.Multiple_Queue_Sporadic_Server is
   use GNAT.Ravenscar.Utils;
...
end GNAT.Ravenscar.Multiple_Queue_Sporadic_Server;
