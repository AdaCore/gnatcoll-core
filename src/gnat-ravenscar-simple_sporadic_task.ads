...
--                                                                          --
--                    G N A T . RAVENSCAR.SIMPLE_SPORADIC_TASK                --
--                                                                          --
--                                 S p e c                                  --
--                                                                          --
...
--  package My_Sporadic_Task is new GNAT.Ravenscar.Simple_Sporadic_Task
--      (Task_Priority => 10,
...
package GNAT.Ravenscar.Simple_Sporadic_Task is
...
end GNAT.Ravenscar.Simple_Sporadic_Task;
