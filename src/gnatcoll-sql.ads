...
package GNATCOLL.SQL is
   ...
   type SQL_Field is abstract new SQL_Field_Or_List with private;
   --  A single field
   ...
   function From_String (Expression : String) return SQL_Field_Text;
   function From_Integer (Expression : String) return SQL_Field_Integer;
   --  Create a field from a field. Expression is an SQL statement, no check is
   --  done though.

   function Expression (Value : String)            return SQL_Field_Text;
   function Expression (Value : Integer)           return SQL_Field_Integer;
   function Expression (Value : Boolean)           return SQL_Field_Boolean;
   function Expression (Value : Float)             return SQL_Field_Float;
   function Expression
   ...
   function As_Days (Count : Natural) return SQL_Field_Time;
   --  An expression representing a number of days

   function Expression_Or_Null (Value : String) return SQL_Field_Text;
   ...
   function Current_Date return SQL_Field_Time;
   function Now return SQL_Field_Time;
   --  Return the current date

   function "-" (Field1, Field2 : SQL_Field_Time) return SQL_Field_Time;
   function "-"
   ...
   function "="   (Left, Right : SQL_Field_Integer) return SQL_Criteria;
   function "="   (Left, Right : SQL_Field_Text)    return SQL_Criteria;
   function "="   (Left, Right : SQL_Field_Boolean) return SQL_Criteria;
   function "="   (Left, Right : SQL_Field_Float)   return SQL_Criteria;
   function "="   (Left, Right : SQL_Field_Time)    return SQL_Criteria;
...
private
   ...
   type SQL_Field_Or_List is abstract new Ada.Finalization.Controlled
      with null record;
   ...
   procedure Free (Self : in out SQL_Field_Internal) is abstract;
   function To_String
     (Self : SQL_Field_Internal; Long : Boolean) return String is abstract;
   procedure Adjust   (Self : SQL_Field_Internal_Access);
   procedure Finalize (Self : in out SQL_Field_Internal_Access);

   procedure Append_Tables
     (Self : SQL_Field_Internal; To : in out Table_Sets.Set);
   ...
   type SQL_Field is abstract new SQL_Field_Or_List with record
      Data : SQL_Field_Internal_Access;
   end record;
   procedure Adjust   (Self : in out SQL_Field);
   procedure Finalize (Self : in out SQL_Field);
   ...
   procedure Free (Self : in out Named_Field_Internal);
   function To_String
   ...
   type SQL_Named_Field is abstract new SQL_Field with null record;

   type SQL_Field_Integer is new SQL_Named_Field with null record;
   type SQL_Field_Text    is new SQL_Named_Field with null record;
   type SQL_Field_Time    is new SQL_Named_Field with null record;
   type SQL_Field_Boolean is new SQL_Named_Field with null record;
   type SQL_Field_Float   is new SQL_Named_Field with null record;

   Null_String : constant String := "NULL";

   type As_Field_Internal is new SQL_Field_Internal with record
      As      : GNAT.Strings.String_Access;
      Renamed : Field_Access;
   end record;
   type As_Field_Internal_Access is access all As_Field_Internal'Class;
   procedure Free (Self : in out As_Field_Internal);
   function To_String
   ...
   type SQL_As_Field is new SQL_Field with null record;
   ...
   procedure Free (Self : in out Multiple_Args_Field_Internal);
   function To_String
   ...
   type SQL_Multiple_Arg_Field is new SQL_Field with null record;
   ...
   procedure Free     (Self : in out Aggregate_Field_Internal);
   function To_String
   ...
   type SQL_Aggregate_Field is new SQL_Field with null record;
   ...
   procedure Free (Self : in out Sorted_Field_Internal);
   function To_String
   ...
   type SQL_Sorted_Field is new SQL_Field with null record;
   ...
   procedure Free (Self : in out Case_Stmt_Internal);
   function To_String
   ...
   type Case_Stmt_Field is new SQL_Field with null record;
   ...
   procedure Free (Self : in out Query_Contents) is abstract;
   function To_String
     (Self : Query_Contents) return Unbounded_String is abstract;
   procedure Auto_Complete
     (Self                   : in out Query_Contents;
      Auto_Complete_From     : Boolean := True;
      Auto_Complete_Group_By : Boolean := True) is abstract;
   ...
   procedure Free (Self : in out Query_Select_Contents);
   function To_String (Self : Query_Select_Contents) return Unbounded_String;
   procedure Auto_Complete
   ...
   procedure Free (Self : in out Query_Insert_Contents);
   function To_String (Self : Query_Insert_Contents) return Unbounded_String;
   procedure Auto_Complete
   ...
   function To_String (Self : Query_Update_Contents) return Unbounded_String;
   procedure Auto_Complete
   ...
   procedure Free (Self : in out Query_Delete_Contents);
   function To_String (Self : Query_Delete_Contents) return Unbounded_String;
   procedure Auto_Complete
   ...
   procedure Free (Self : in out Simple_Query_Contents);
   function To_String (Self : Simple_Query_Contents) return Unbounded_String;
   procedure Auto_Complete
