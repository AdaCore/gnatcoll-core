...
--                                                                          --
--        G N A T . RAVENSCAR.SIMPLE_SPORADIC_SERVER_WITH_CALLBACK          --
--                                                                          --
--                                 S p e c                                  --
--                                                                          --
...
--    new GNAT.Ravenscar.Sporadic_Server_With_Callback
--       Task_Priority => 10,
...
package GNAT.Ravenscar.Sporadic_Server_With_Callback is
...
private
   ...
   package My_Sporadic_Task is new GNAT.Ravenscar.Sporadic_Server (
      Task_Priority,
...
end GNAT.Ravenscar.Sporadic_Server_With_Callback;
